...
import aurora from 'c:/Users/BOSS1/dhyuthi_5.0/assets/aurora.jpg';
import ignitia from 'c:/Users/BOSS1/dhyuthi_5.0/assets/ignitia.jpg';
import traverse from 'c:/Users/BOSS1/dhyuthi_5.0/assets/traverse.jpg';
const Tracks = () => {
  return (
      ...
      <div className='max-w-[1380px] mx-auto grid lg:grid-cols-3 gap-8'>
        ...
        <div className='mx-auto mt-[-3rem] bg-white'>
          ...
          {/*  <h2 className='my-16 text-3xl font-bold text-center'>AURORA</h2>
            ...
            <button className='bg-gradient-to-r from-[#efb98f] via-[#ef9a06] to-[#f1871d] w-[200px] rounded-md font-medium my-8 mx-auto px-6 py-3 text-black'>Register now</button>
        </div>
        ...
        <div className='mx-auto mt-[-3rem] bg-white'>
          ...
          {/*  <h2 className='my-16 text-3xl font-bold text-center'>TRAVERSE</h2>
            ...
            <button className='bg-gradient-to-r from-[#efb98f] via-[#ef9a06] to-[#f1871d] w-[200px] rounded-md font-medium my-6 mx-auto px-6 py-3 text-black'>Register now</button>
        </div>
    ...
    <div className='py-32 pb-0'>
      ...
      <p className='flex items-center justify-center text-5xl font-bold'>TICKETS</p>

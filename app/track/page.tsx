      ...
      <div className='max-w-[1380px] mx-auto grid lg:grid-cols-3 gap-8'>
        ...
        <div className='w-20 mx-auto mt-[-3rem] bg-white'>
          <Image src={single} alt="" width="80" height="80" />
            ...
            <button className='bg-gradient-to-r from-[#efb98f] via-[#ef9a06] to-[#f1871d] w-[200px] rounded-md font-medium my-8 mx-auto px-6 py-3 text-black'>Register here</button>
        </div>
        ...
        <div className='w-20 mx-auto mt-[-3rem] bg-white'>
          <Image src={double} alt="" width="80" height="80" />
            ...
            <button className='bg-gradient-to-r from-[#efb98f] via-[#ef9a06] to-[#f1871d] w-[200px] rounded-md font-medium my-6 mx-auto px-6 py-3 text-black'>Register here</button>
        </div>
